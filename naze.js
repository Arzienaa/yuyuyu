...
const nyoutube = ('© Y U I 🌊\n Gc nya YUI>< :\nhttps://chat.whatsapp.com/HE23jMJF3sAGPbLv48OAuP')  //ubah di config biar ngk emror
...
const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')  
 if(time2 < "23:59:00"){
var ucapanWaktu = 'Selamat Malam kka 😗🌌'
 }
 if(time2 < "19:00:00"){
var ucapanWaktu = 'Selamat Sore kka 😗🌃'
 }
 if(time2 < "18:00:00"){
var ucapanWaktu = 'Selamat Sore kka 😗🌅'
 }
 if(time2 < "15:00:00"){
var ucapanWaktu = 'Selamat Siang kka 😗🏙'
 }
 if(time2 < "11:00:00"){
var ucapanWaktu = 'Selamat Pagi kka 😗🌄'
 }
 if(time2 < "05:00:00"){
var ucapanWaktu = 'Selamat Pagi kka 😗🌉'
 } 
...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
	    ...
	    //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thumb, surface: 200, message: 'YUI🌊', orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: 'YUI🌊',jpegThumbnail: thumb}}}
		const fvn = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":'YUI🌊', "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': 'YUI🌊', 'jpegThumbnail': thumb}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "Y U I", "caption": 'YUI🌊', 'jpegThumbnail': thumb}}}
...
jumlahharian = `${dataa.value}`
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        m.reply(`「 *ANTI LINK* 」\n\n*Kamu terdeteksi mengirim link group*, *maaf kamu bakalan yui kick ‼️,yang mau juga silahkan kirim link‼️*`)
        ...
        if (isCreator) return m.reply(`*maaf ka melly*`)
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/5b95c8da9fca67313a29c.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Mau donasi yaa???*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\nhttps://wa.me/62822885723567\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n Ke nomer berikut : 0822885723567\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('https://wa.me/62822885723567')
            }
            break		 
            case 'chat': {
		...
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '▶️List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Donasi🦈' }, type: 1 }]
...
//PEMBATAS=======================================
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
            ...
            case 'tiktok': case 'tiktoknowm': {
                ...
                let buttons = [
                    {buttonId: `allmenu`, buttonText: {displayText: '▶️List Menu'}, type: 1},
...
rules = `┌──⭓ *YUI >.<*
  ...
  *Iya kenapa sayang hm? perlu bantuan?*


└───────⭓`
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'Iya yui:(' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🌊Sewa' }, type: 1 }]
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '▶️List Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'YUI🌊' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Donasi🦈' }, type: 1 }]
